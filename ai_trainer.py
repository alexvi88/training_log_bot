...
- Рабочий диапазон — 5-10 повторений в подходе. Исключение — присед, становая и
...
в 5-10: восьмёрка в становой это не силовая работа, а испытание поясницы, и
...
а не недобор диапазона. Не пиши про них «диапазон 5-10 ты не добрал», не советуй
