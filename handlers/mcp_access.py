...
_INTRO = (
    ...
    "группам мышц, вес тела, питание, программы. Писать — только вес и еду, "
    "теми же словами, что и в чате с тренером («занеси 78.4», «съел овсянку "
    "с бананом») — поправить или убрать запись потом можно здесь же, в боте. "
    "Переписка с AI-тренером наружу не уходит, и программы отсюда не собрать."
)
