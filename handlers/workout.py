...
# Постоянная строка ниже («🔢 Жми повторы — запишу на …», см.
...
def _logging_hint(
    ...
    if reps_row:
        ...
        # тренер — «Жми повторы — запишу на 25кг». Без «подход»: со словом
        # строка на трёхзначном весе (например 200кг) переносится на второй
        # экранный ряд в мобильном Telegram — семь лишних символов ломают
        # ряд кнопок, стоящий сразу под этой строкой.
        ...
        reps_row_line = f"{hint_prefix}🔢 Жми повторы — запишу на {weight_str}\n"
