...
# «Другое» — мешок для предплечий, трапеций и всего, что не легло в семь
# основных групп (пресс с него съехал в свою группу — ему подсказка нужна). «Другое — 31% восстановления» не подсказывает ничего: это не
