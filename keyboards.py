...
# сколько в прошлый раз», а прогрессия. Окно вниз почти не нужно (сорваться
# ниже прошлого раза на свежую голову — редкость), а вверх — как раз то, что
# обычно и происходит, и где стоит цель прогрессии (analytics.suggest_progression).
_REPS_BELOW_FIRST_SET = 1
_REPS_ABOVE_FIRST_SET = 4
