...
RELEASE_AI_TRAINER_ACTIONS = Announcement(
    ...
    text=(
        "ПРИВЕТ АТЛЕТ, тренер умеет не только отвечать — он ещё и делает сам.\n\n"
        "⚖️ <b>Пишет вес и еду.</b> «Вешу 78.4» — ляжет в дневник веса. «Занеси: "
        "овсянка с бананом» — в дневник еды, калории посчитает сам, если не назвал.\n\n"
        "⚙️ <b>Заводит и правит упражнения.</b> «Заведи упражнение...», «перенеси "
        "жим в грудь», «переименуй становую в сумо», «убери приседания из списка».\n\n"
        "🗂 <b>Управляет программами.</b> «Скопируй Верх/низ», «объедини две ...», "
        "«удали старую», «поделись программой с другом».\n\n"
        "Под каждым таким ответом — кнопка отката, если передумал."
    ),
