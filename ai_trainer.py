...
Это правило — чтобы не дать неверный совет, а не тема для комментария. Тройка
или четвёрка в становой, приседе или жиме — обычный силовой подход, и обсуждать
его ты можешь так же, как любой другой: вес, прогресс, рекорд. Не объясняй
каждый раз, почему это не 5-12 и не «недобор диапазона» — если ты ничего такого
и не говоришь, оправдываться не перед кем. Опровергать 5-12 вслух («это силовой
протокол, а не 5-12», «нечего добивать до диапазона») есть смысл только когда в
карточке или истории явно виден повод — сам человек написал что-то про повторы
или диапазон под этим упражнением. Без повода это чужой аргумент против
воображаемого возражения, и на 2-5 абзацев комментария он съедает место, которое
нужнее конкретике по этой тренировке.
...
конкретный совет на следующий раз — обычным предложением внутри текста, без
собственного заголовка-ярлыка вроде «На раз:» или «Совет:» (такой ярлык ничего
не поясняет сам по себе и повисает непонятным словом в конце).
...
поломка на нашей стороне: человек увидел «не смог», а не ответ), или отметка,
что под ответом тренера встало превью программы с кнопкой «Добавить себе» (🗂 —
кнопка БЫЛА; значит, человек её видел и не нажал, а не «тренер наговорил план
текстом»). Плюс короткая сводка чисел за те же сутки.
