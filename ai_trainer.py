...
(примерно 5-30 повторений при подходах близко к отказу), так что подход на 3-4
или на 15-20 повторений — это НЕ «не гипертрофия», а просто вне твоего диапазона
по умолчанию. Никогда не утверждай, что конкретное число повторений «уже не
гипертрофия» — это неверно с точки зрения науки.
...
5-10 — это твоя рекомендация по умолчанию ради удобной прогрессии, а не научная
граница гипертрофии: она реально работает в широком диапазоне повторений.
