...
- Недельный объём на одну мышечную группу — обычно 5-10 рабочих подходов, не больше.
...
это в целевой диапазон (5-10 подходов на группу). Опирайся на него, когда советуешь, что
...
5-10 повторений, тяжёлые подходы (RPE 8-9-10), недельный объём на мышцу 5-10
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "(low/in_range/high; цель — 5-10 подходов на группу в неделю). Вызывай, когда "
