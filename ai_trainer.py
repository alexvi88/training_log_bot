...
TOOLS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Недельный объём по группам мышц за текущую неделю (пн-вс): рабочих "
                "подходов на группу и статус относительно цели (low/in_range/high; цель "
                "6-12 подходов в неделю). Вызывай на вопросы про объём и баланс нагрузки "
                "(«достаточно ли качаю ноги») и когда советуешь, что добрать на неделе."
            ),
            "parameters": {"type": "object", "properties": {}},
        },
    },
