...
def _logging_hint(
    ...
    if reps_row:
        ...
        # Глагол «запишу» тоже убрали: на трёхзначном весе (например 200кг)
        # строка переносилась на второй экранный ряд в мобильном Telegram —
        # лишние символы ломают ряд кнопок, стоящий сразу под этой строкой.
